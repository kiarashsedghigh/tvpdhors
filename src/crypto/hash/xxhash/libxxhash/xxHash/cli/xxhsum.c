/*
 * xxhsum - Command line interface for libxxhash algorithms
                          ...
                          XSUM_U32 algoBitmask)
{
    ...
    if (inFileName == stdinName) {
        /*
         * Note: Since we expect text input for libxxhash -c mode,
...
static int XSUM_usage(const char* exename)
{
    ...
    XSUM_log( "\nOptions: \n");
    XSUM_log( "  -H#          select an libxxhash algorithm (default: %i) \n", (int)g_defaultAlgo);
    XSUM_log( "               0: XXH32 \n");
    XSUM_log( "               1: XXH64 \n");
