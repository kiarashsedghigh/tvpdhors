 ...
 * Validates that libxxhash.h can be included multiple times and in any order
 *
 ...
 * This test ensures that libxxhash.h can be included multiple times
 ...
 *
 * To be linked with and without libxxhash.o
